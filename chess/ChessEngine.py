...
# see the last move that was made and reverse it
    ...
    def getBishopMoves(self, row, col, moves):
        ...
        for direction in directions:
            for i in range(1,8):
                endRow = row + direction[0] * i #iteratively goes through each row in the diagonal direction
                endCol = col + direction[1] * i #iteratively goes through each column in the diagonal direction
                if (0 <= endRow < 8 and 0 <= endCol < 8) == False:
                    break
